...
export class ImageLinkStorageService{
    ...
    GetByID(id:string, api:string, success, failed){
        this.rs.SimplifyGet(this.gser.uploadURL+"ImageLinkStorage/GetByID?id="+id+"&aid="+api, this.headers, success.bind(this), failed.bind(this))
    }
    ...
    GetByOIDAPIVM(oid:string, api:string, success, failed){
        this.GetByOIDAPI(oid, api, function(data){
