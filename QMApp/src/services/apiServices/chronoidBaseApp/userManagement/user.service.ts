...
export class UsersServices{
    ...
    CreateNewUser(userInfo:UsersViewModel, api:string, position:PositionViewModel, success, failed){
        this.CreateUser(userInfo, api, function(){
            this.InsertNewUserLocation(userInfo.ID, userInfo.ID, api, position, "", success.bind(this), failed.bind(this))
